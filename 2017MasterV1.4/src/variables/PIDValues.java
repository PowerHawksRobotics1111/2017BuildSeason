...
public class PIDValues {
	...
	public static final PIDController leftDrive1Rotate = new PIDController(PIDValues.DRIVE_TRAIN_KP,
			PIDValues.DRIVE_TRAIN_KI, PIDValues.DRIVE_TRAIN_KD, 0.0, Motors.motorDriveLeft1, Motors.motorDriveLeft1);
	public static final PIDController leftDrive2Rotate = new PIDController(PIDValues.DRIVE_TRAIN_KP,
			PIDValues.DRIVE_TRAIN_KI, PIDValues.DRIVE_TRAIN_KD, 0.0, Motors.motorDriveLeft2, Motors.motorDriveLeft2);
	public static final PIDController rightDrive1Rotate = new PIDController(PIDValues.DRIVE_TRAIN_KP,
			PIDValues.DRIVE_TRAIN_KI, PIDValues.DRIVE_TRAIN_KD, 0.0, Motors.motorDriveRight1, Motors.motorDriveRight2);
	public static final PIDController rightDrive2Rotate = new PIDController(PIDValues.DRIVE_TRAIN_KP,
