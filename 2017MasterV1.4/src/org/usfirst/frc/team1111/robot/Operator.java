...
public class Operator {
	...
	static void autoAlignPeg()
	{
		...
		} else
		{
			...
			aligned = false;
			//If we want, we can give them a separate reset so they can pause align without cancel.
		}
	}
	...
	static void intake()
	{
		if (Joysticks.joyOp.getRawButton(Joysticks.Buttons.intakeButton))//But it still will read like this so...
