...
public class Joysticks {
	...
	// Buttons numbers
	public static final int X = 1, A = 2, B = 3, Y = 4, RIGHT_BUMPER = 5, LEFT_BUMPER = 6, LEFT_TRIGGER = 7,
	...
	public static final class Buttons {
		...
		public static final int intakeButton = LEFT_TRIGGER;
		public static final int outtakeButton = LEFT_BUMPER;
		public static final int shootButton = RIGHT_TRIGGER;
		public static final int gearRelease = RIGHT_BUMPER;
