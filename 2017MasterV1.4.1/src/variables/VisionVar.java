...
public class VisionVar
{
	...
	public final static double centerXVision = 160.0, centerYVisionB = 100.0, centerYVisionG = 120.0,
			areaVision = 6174.0, widthVision = 159.0, heightVision = 125.0, focalLengthB = 241.733,
			focalLengthG = 190.681, fieldOfViewB = 67.0, fieldOfViewG = 80.0, pixelWidth = 320;
